...
Question.find_by(text: 'Who should be the next president?').choices.create!
                          [{ :text => 'Bernie Sanders'},
                          { :text => 'Donald Trump'},
                          { :text => 'Jeb Bush'},
                          { :text => 'None of the above'}]

Question.find_by(text: 'What do you want for dinner tonight?').choices.create!
                         [{ :text => 'Macaroni and Cheese'},
                          { :text => 'Burgers'},
                          { :text => 'Caprese Salad'},
                          { :text => 'Pizza and Beer'}]

Question.find_by(text: 'Which is your favorite Hemingway novel?').choices.create!
